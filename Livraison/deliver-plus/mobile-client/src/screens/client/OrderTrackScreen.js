    ...
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
      ...
      <View style={styles.card}>
        ...
        {driverPos ? (
          ...
          <View style={styles.liveBox}>
            <Text style={{ color: COLORS.muted, fontSize: 13 }}>Position du livreur indisponible</Text>
          </View>
        )}
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.routeRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.routeAddress} numberOfLines={2}>{order.pickupAddress?.label || '—'}</Text>
          </View>
        </View>
        ...
        <View style={styles.routeRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.routeAddress} numberOfLines={2}>{order.deliveryAddress?.label || '—'}</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  liveCoords:      { fontSize: 12, color: COLORS.muted, marginBottom: 10 },
